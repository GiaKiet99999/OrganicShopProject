...
<tbody>
    <c:forEach var="product" items="${cart}">
        <tr>
            ...
            <td>
                <div class="input-group quantity mt-4" style="width: 100px;">
                    <div class="input-group-btn">
                        <form action="/product/cart/update/${product.productId}" method="post" style="display:inline;">
            ...
            <td>
                <form action="/product/cart/remove/${product.productId}" method="post">
        ...
        <div class="bg-light rounded">
            ...
            <div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
               ...
               <%--  <h5 class="mb-0 ps-4 me-4">Sub: ${subtotal}</h5>
                ...
                <p class="mb-0 pe-4">${subtotal} </p> <!-- Hiển thị Total sau khi giảm giá -->
            </div>
