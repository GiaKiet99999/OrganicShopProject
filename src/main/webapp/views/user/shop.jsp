                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-xl-3">
						    <div class="bg-light ps-3 py-3 rounded d-flex justify-content-between mb-4">
						        ...
						        <form id="sortingForm" action="/product/index" method="get">
                                        ...
                                        <c:forEach var="category" items="${categories}">
                                            <li>
                                                <div class="d-flex justify-content-between fruite-name">
                                                    <a href="/product/index?categoryId=${category.categoryId}"><i class="fas fa-apple-alt me-2"></i>${category.categoryName}</a>
                                                </div>
                                            </li>
                                            </c:forEach>
                                        </ul>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <h4 class="mb-2">Price Range:</h4>
                                        	<form action="/product/index" method="get" class="w-100 d-flex">
